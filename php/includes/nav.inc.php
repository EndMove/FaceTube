<nav class="main">
      <ul>
        <li class="banner"><img src="img/FaceTube-logo.png" alt="logo"><span>FaceTube</span></li>
        <li><a href="home.php" <?php if($page=='home') echo 'class="active"'; ?>>Accueil</a></li>
        <li><a href="search.php" <?php if($page=='search') echo 'class="active"'; ?>>Rechercher</a></li>
      ...
      <?php } else { ?>
        ...
        <li><a href="register.php" <?php if($page=='register') echo 'class="active"'; ?>>Inscription</a></li>
      <?php } ?>
      </ul>
    </nav>
